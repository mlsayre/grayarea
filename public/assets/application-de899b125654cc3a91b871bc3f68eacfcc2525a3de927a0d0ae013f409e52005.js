...
var targetwordsfx = new Howl({
  src: ['/assets/targetword.wav'],
  volume: 1,
  preload: true
});
var neutralwordsfx = new Howl({
  src: ['/assets/neutral2.wav'],
  volume: 1,
  preload: true
});
var badwordsfx = new Howl({
  src: ['/assets/spoiler2.wav'],
  volume: 1,
  preload: true
});
var bonusstartsfx = new Howl({
  src: ['/assets/bonusstart.wav'],
  volume: 1,
  preload: true
});
var gameovergoodsfx = new Howl({
  src: ['/assets/gameovergood.wav'],
  volume: 1,
  preload: true
});
var resultscheersfx = new Howl({
  src: ['/assets/ResultsCheer.mp3'],
  volume: 1,
  preload: true
});
